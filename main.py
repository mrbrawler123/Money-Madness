...
time.sleep(3)
print(
    "You have to enter for rock, paper and scissor. You have to earn double of your initial amount by betting an amount for the next round."
)
time.sleep(1)
...
while amount != 2 * initial_amount:
	...
	time.sleep(2)
	if (think == "rock" and choice == "paper") or (
	    think == "paper" and choice == "scissor") or (think == "scissor"
	                                                  and choice == "rock"):
		amount = amount + bet
		...
		continue
	if (think == "paper" and choice == "rock") or (
	    think == "scissor" and choice == "paper") or (think == "rock"
	                                                  and choice == "scissor"):
		amount = amount - bet
		if amount == 0:
